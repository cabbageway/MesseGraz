...
<body onload="onload()">
                ...
                <form id="mainForm" action="admin.php?messe=<?php echo $fair; ?>" method="post" enctype="multipart/form-data">
                            ...
                            if ($_FILES['image']['size'] > 1000000) {
                                ...
                                if ($_FILES['image']['size'] > 0) {
                                    if (move_uploaded_file($_FILES['image']['tmp_name'], $localFileName)) {
                                        $db->updateCoupon($_GET['update'], $localFileName, $_POST["title"], $_POST["category"], $_POST['content'], $fair, $_POST['number'], $_POST['limit'], $_POST['weblink1'], $_POST['weblink2']);
                                    }
                                } else {
                                    $db->updateCoupon($_GET['update'], $localFileName, $_POST["title"], $_POST["category"], $_POST['content'], $fair, $_POST['number'], $_POST['limit'], $_POST['weblink1'], $_POST['weblink2']);
                                }
                    ...
                    if (!empty($_FILES['image']['name']) && !isset($_GET['update']) && !isset($_GET['delete'])) {
                        ...
                        if ($_FILES['image']['size'] > 1000000) {
                            ...
                            if ($_FILES['image']['size'] > 0) {
                                if (move_uploaded_file($_FILES['image']['tmp_name'], $localFileName)) {
                                    $db->insertCoupon($localFileName, $_POST["title"], $_POST["category"], $_POST['content'], $fair, $_POST['number'], $_POST['limit'], $_POST['weblink1'], $_POST['weblink2']);
                                }
                    ...
                    <!-- KW -->
                    <div class="mb-3 mt-3">
                        <label for="weblink1" class="form-label">Weblink1:</label>
                        <input type="text" class="form-control" id="weblink1" placeholder="Weblink z.B. facebook..." name="weblink1">
                    </div>
                    <div class="mb-3 mt-3">
                        <label for="weblink2" class="form-label">Weblink2:</label>
                        <input type="text" class="form-control" id="weblink2" placeholder="Weblink z.B. instagram..." name="weblink2">
                    </div>
    ...
    <script>
        ...
        function updateCupon(id) {
            ...
            document.getElementById("weblink1").value =td[4].getAttribute("web1");
            document.getElementById("weblink2").value = td[4].getAttribute("web2");
